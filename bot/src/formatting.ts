/**
 * Formatting module for Survivor Fantasy Telegram Bot.
 *
...
export function convertMarkdownToHtml(text: string): string {
  ...
  // Headers: ## Header -> <b>Header</b> with extra spacing
  ...
  // Bullet lists: - item or * item -> • item (with spacing between list items)
  ...
  // Collapse excessive newlines (4+ becomes 2) but preserve intentional spacing
  text = text.replace(/\n{4,}/g, "\n\n");
