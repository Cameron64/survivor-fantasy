...
function useLeaguePaths() {
  const pathname = usePathname()
  const leagueSlug = pathname.split('/')[1]
  return {
    submitBase: `/${leagueSlug}/events/submit`,
    tribalBase: `/${leagueSlug}/events/submit/tribal-council`,
  }
}
...
export function AttendeesStep() {
  ...
  const { submitBase, tribalBase } = useLeaguePaths()
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2 pt-4">
        <Button variant="outline" onClick={() => router.push(submitBase)}>
          Back
        </Button>
        <Button
          className="flex-1"
          onClick={() => router.push(`${tribalBase}/votes`)}
...
export function VotesStep() {
  const router = useRouter()
  const { tribalBase } = useLeaguePaths()
  ...
  if (selectedAttendees.size < 2) {
    router.push(`${tribalBase}/attendees`)
    return null
  }

  const handleNext = () => {
    if (allVotesCast && tieInfo.isTied) {
      router.push(`${tribalBase}/tie-resolution`)
    } else {
      ...
      router.push(`${tribalBase}/elimination`)
    }
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2 pt-4">
        <Button variant="outline" onClick={() => router.push(`${tribalBase}/attendees`)}>
          Back
        </Button>
        <Button
          className="flex-1"
...
export function TieResolutionStep() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2 pt-4">
        <Button variant="outline" onClick={() => router.push(`${tribalBase}/votes`)}>
          Back
        </Button>
      </div>
    </div>
...
export function RevoteStep() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2 pt-4">
        <Button variant="outline" onClick={() => router.push(`${tribalBase}/tie-resolution`)}>
          Back
        </Button>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2 pt-4">
        ...
        <Button
          className="flex-1"
          onClick={() => router.push(`${tribalBase}/extras`)}
          disabled={!eliminated}
        >
...
export function EliminationStep() {
  ...
  const backPath = hasRevote ? `${tribalBase}/revote`
    : eliminationMethod === 'consensus' ? `${tribalBase}/tie-resolution`
    : `${tribalBase}/votes`
...
export function ExtrasStep() {
  ...
  const handleSubmit = () => {
    ...
    router.push(`${tribalBase}/review`)
  }

  const backPath = eliminationMethod === 'rock_draw' ? `${tribalBase}/rock-draw` : `${tribalBase}/elimination`
