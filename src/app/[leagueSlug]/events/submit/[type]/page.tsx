...
export default function EventFormPage() {
  ...
  if (eventType === 'TRIBAL_COUNCIL') {
    redirect(`/${leagueSlug}/events/submit/${params.type}/attendees`)
  }

  const handleFormSubmit = useCallback(
    (data: GameEventData) => {
      setFormData(data)
      router.push(`/${leagueSlug}/events/submit/${params.type}/review`)
    },
    [setFormData, router, params.type, leagueSlug]
  )
