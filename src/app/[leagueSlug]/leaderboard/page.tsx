...
import { requireLeagueBySlug } from '@/lib/league-context'
...
async function getOverviewData(leagueSlug: string) {
  const [currentUser, teams, allDbContestants, league, tribes] = await Promise.all([
    ...
    requireLeagueBySlug(leagueSlug),
...
export default async function LeaderboardPage({
  ...
  const { currentUserId, standings, contestants, weekEventsData, maxScore, showLastPlace } =
    await getOverviewData(leagueSlug)
